...
public class StructureModifier<T> {
  ...
  public StructureModifier(Object target) {
  ...
  public StructureModifier<T> withTarget(Object target) {
    return new StructureModifier<T>(targetClass, target, fieldType, converter);
  }

  public <R> StructureModifier<R> withType(Class<?> type) {
    return new StructureModifier<R>(targetClass, target, type, null);
  }

  public <R> StructureModifier<R> withType(Class<?> type, EquivalentConverter<R> converter) {
    return new StructureModifier<R>(targetClass, target, type, converter);
  }

  public <R> StructureModifier<R> withConverter(EquivalentConverter<R> converter) {
    return new StructureModifier<R>(targetClass, target, fieldType, converter);
  }
