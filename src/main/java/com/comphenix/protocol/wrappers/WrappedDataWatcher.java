...
public class WrappedDataWatcher {
  ...
  public static class WrappedDataWatcherObject { private final int index; private final Object serializer; public WrappedDataWatcherObject(int i,Object s){index=i;serializer=s;} public int getIndex(){return index;} public Object getSerializer(){return serializer;} }
}
